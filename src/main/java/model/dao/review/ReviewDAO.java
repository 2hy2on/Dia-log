...
public class ReviewDAO {
    ...
    public boolean registerReview(Review review) {
    	...
    	LocalDate currentDate = LocalDate.now();
         ...
         query.append("INSERT INTO Review (title, content, rate,createdAt, updatedAt, watchedAt, isPrivate, contentId, writerId) VALUES (?, ?, ?,?, ?,?,?,?,?)");

  		Object[] param = new Object[] {review.getTitle(),review.getContent(), review.getRate(), currentDateTime,currentDateTime,currentDate, review.isPrivate(), review.getContentId(), review.getWriterId()};
...
//    			review.setMediaImg(rs.getString("mediaImg"));
    ...
    public boolean updateReview(int reviewId, Review review) {
    	 ...
    	 LocalDateTime currentDateTime = LocalDateTime.now();
     	LocalDate currentDate = LocalDate.now();
         query.append("UPDATE Review SET title =?, rate=?, watchedAt=?,isPrivate=?, content=?,updatedAt=? where reviewId =?");

  		Object[] param = new Object[] {review.getTitle(), review.getRate(), review.getWatchedAt(), review.isPrivate(), review.getContent(), currentDate, reviewId};
