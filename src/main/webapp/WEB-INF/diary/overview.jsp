...
<link rel="stylesheet" id="main-stylesheet" data-version="1.1.0"
	href="<c:url value='/css/diary/shards-dashboards.1.1.0.min.css'/>">
<link rel="stylesheet"
	href="<c:url value='/css/diary/extras.1.1.0.min.css'/>">
<script async defer src="https://buttons.github.io/buttons.js"></script>
	...
	<body class="h-100">
									...
									<div class="card-body p-0 d-flex">
										<div class="d-flex flex-column m-auto">
											<div class="stats-small__data text-center">
												<span id="genreName1"
													class="stats-small__label text-uppercase"></span>
												<h6 id="sum1" class="stats-small__value count my-3"></h6>
											</div>
											<div class="stats-small__data"></div>
										</div>
											...
											<div class="col-12 col-sm-6">
												<div id="blog-overview-date-range"
													...
													<input type="text" class="input-sm form-control"
														...
														id="blog-overview-date-range-1"> <input
		...
		<script
			src="<c:url value='/js/diary/shards-dashboards.1.1.0.min.js'/>"></script>
